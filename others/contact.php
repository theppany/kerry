...
<script type="text/javascript">
    ...
    function createMap(){
        ...
        var point = new BMap.Point(113.918834,22.583588);//定义一个中心点坐标
    ...
    //标注点数组
    var markerArr = [{title:"方华工业区西栋五楼",content:"方华工业区西栋五楼",point:"113.917769|22.58393",isOpen:0,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}}
		 ];
    //创建marker
    function addMarker(){
